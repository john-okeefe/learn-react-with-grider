...
/* Create a new component. This component should produce some HTML. This is
considered a functional component. Changing function based componenet (check
  ...
  render() {
    return (
      <div>
        <SearchBar />
        {
          /* To give the child VideoList access to the information from the
          parent index or "App" we just add a line to the JSX. Passing this
          information into VideoList is called passing in props. We are passing
          prop videos to VideoList. */
        }
...
/* .render requires a second argument to say where in the HTML document we are
